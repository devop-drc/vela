...
const Frame = ({ src, url, tilt }: { src: string; url: string; tilt?: "l" | "r" }) => (
  ...
  <div className="group relative">
    ...
    >
      ...
      <div className="overflow-hidden"><img src={src} alt="" loading="lazy" decoding="async" className="fs-img block aspect-[1440/900] w-full object-cover object-top" /></div>
    </div>
  </div>
);
...
export default function FeatureShowcase({ lang }: { lang: Lang }) {
  ...
  const feats = [
    { Icon: Sparkles, label: t(lang, "Analizë nga sistemi", "System analysis"), title: t(lang, "Çdo postim bëhet produkt", "Every post becomes a product"), body: t(lang, "Sistemi nxjerr emrin, çmimin, kategorinë dhe variantet — vetë. Dhe kur krijon produkte të reja, i poston vetë në Instagram.", "The system extracts name, price, category and variants — automatically. And when you create new products, it posts them to Instagram for you."), bullets: [t(lang, "Emra & çmime nga postimet", "Names & prices from posts"), t(lang, "Kategori & variante", "Categories & variants"), t(lang, "Poston edhe mbrapsht: produkti bëhet postim", "Works in reverse too: product becomes post")], img: "/hero/web/products.jpg", url: "dyqani.yt/products" },
    { Icon: Palette, label: "Storefront Studio", title: t(lang, "Dizajno vitrinën tënde", "Design your storefront"), body: t(lang, "Zgjidh një template dhe personalizo gjithçka, me pamje live.", "Pick a template, customize everything, preview it live."), bullets: [t(lang, "8+ template", "8+ templates"), t(lang, "Ngjyra, fonte, struktura", "Colors, fonts, layout"), t(lang, "Pamje live", "Live preview")], img: "/hero/web/studio.jpg", url: "dyqani.yt/studio", reverse: true },
    { Icon: CreditCard, label: t(lang, "Pagesa & Porosi", "Payments & orders"), title: t(lang, "Merr pagesa. Menaxho porosi.", "Take payments. Manage orders."), body: t(lang, "Kartë me RaiAccept ose para në dorë — porositë në një panel.", "Card via RaiAccept or cash on delivery — orders in one dashboard."), bullets: [t(lang, "Kartë (RaiAccept) ose cash", "Card (RaiAccept) or cash"), t(lang, "Statuse & përmbushje", "Statuses & fulfillment"), t(lang, "Njoftime në kohë reale", "Real-time notifications")], img: "/hero/web/orders.jpg", url: "dyqani.yt/orders" },
    { Icon: BarChart3, label: t(lang, "Analitikë", "Analytics"), title: t(lang, "Shiko çfarë shet", "See what sells"), body: t(lang, "Të ardhura, top produkte dhe klientë — të gjitha live.", "Revenue, top products and customers — all live."), bullets: [t(lang, "Të ardhura & shitje", "Revenue & sales"), t(lang, "Top produktet", "Top products"), t(lang, "Aktivitet live", "Live activity")], img: "/hero/web/dashboard.jpg", url: "dyqani.yt/dashboard", reverse: true },
  ];
