...
import { ShoppingCart, ArrowRight, Trash2, Minus, Plus, Bookmark, MoveRight } from "lucide-react";
...
export const StorefrontCartModal = ({ onClose, onProceedToCheckout }: StorefrontCartModalProps) => {
  ...
  return (
    <div className="flex flex-col h-full">
              ...
              <div className="space-y-4">
                ...
                {cartItems.map(item => (
                  <Card key={item.productId} className={cn(
                    ...
                    <div className="flex-1 w-full sm:w-auto grid grid-cols-1 md:grid-cols-2 items-center gap-4 text-center sm:text-left"> {/* Adjusted grid for wider modal */}
                      <div>
      ...
      <div className="p-6 border-t space-y-4">
        ...
        <Button className="w-full" onClick={onProceedToCheckout} disabled={cartItems.length === 0}>
          Proceed to Checkout
