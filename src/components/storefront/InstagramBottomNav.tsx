...
export const InstagramBottomNav = ({ onOpenCart, onOpenMyOrders, myOrdersCount }: InstagramBottomNavProps) => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 left-0 right-0 z-50 flex justify-center w-full h-[var(--instagram-bottom-nav-height)]" // Use CSS variable for height
    >
      <nav className="bg-white text-gray-800 border-t border-gray-200 shadow-lg h-full w-full max-w-md rounded-t-xl">
