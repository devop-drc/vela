...
export const OutOfStockActionsToolbar = ({ selectedCount, onClear, onAddStock, onDelete }: OutOfStockActionsToolbarProps) => {
  return (
    ...
    >
      ...
      <Button variant="outline" size="sm" onClick={onAddStock} className="text-emerald-600 border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"><CheckCircle className="mr-2 h-4 w-4" />Stock Added</Button>
