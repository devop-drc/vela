...
interface BulkActionsToolbarProps {
  ...
  onDelete: () => void;
  onAddSale: () => void;
  pageContext: 'products' | 'out-of-stock';
}

export const BulkActionsToolbar = ({ selectedCount, onClear, onSetStatus, onDelete, onAddSale, pageContext }: BulkActionsToolbarProps) => {
  return (
    <motion.div
