        ...
        >
            <div className="space-y-4 p-4 border rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <ColorPickerInput label="Accent / Hover" value={settings['--accent']} onChange={(v) => updateSetting('--accent', v)} />
                    <ColorPickerInput label="Accent Text" value={settings['--accent-foreground']} onChange={(v) => updateSetting('--accent-foreground', v)} />
                    <ColorPickerInput label="Borders & Inputs" value={settings['--border']} onChange={(v) => updateSetting('--border', v)} />
                    <ColorPickerInput label="Focus Ring" value={settings['--ring']} onChange={(v) => updateSetting('--ring', v)} />
