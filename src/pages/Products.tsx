...
const Products = () => {
  ...
  useEffect(() => {
    if (searchParams.get("instagram_connected") === "true") {
      showSuccess("Successfully connected! Now syncing your posts...");
      handleSync();
  ...
  const handleSync = async () => {
    setIsSyncing(true);
    const toastId = showLoading("Analyzing Instagram posts with AI... This may take a moment.");
    try {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Products are automatically created from your Instagram posts. Click "Sync" to check for new posts.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                ...
                {products.length > 0 ? products.map((product) => (
                  ...
                  <TableRow>
                    <TableCell colSpan={5} className="h-24 text-center">
                      No products found. Sync with Instagram to get started.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
