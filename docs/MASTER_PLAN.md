...
- ☐ Sections (high-converting, IG-seller narrative):
  1. **Hero** — headline "Turn your Instagram into an online store in minutes", animated device mockup showing IG post → product, primary CTA "Start 7-day free trial", social proof strip. GSAP timeline reveal + parallax.
